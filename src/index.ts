...
/**
 * Fill the empty #root with the boot skeleton. React's createRoot clears the
 * container on mount, so the skeleton is replaced without cleanup logic; it
 * only ever paints during the JS-less window.
 */
